...
public class Testproyectofinal {
  ...
  @Test
   ...
   WebElement reg = table.findElement(By.xpath("(/html/body/div/div/div/[2]/table/tbody/tr"));
   WebElement email = reg.findElement(By.xpath("(/html/body/div/div/div/[2]/table/tbody/td[2]"));
